...
<form:form id="form" commandName="itemSearchCommand" method="post" >
    <div id="searchInfo">
        <h2 style="font-weight:bold; color:green; text-align:center;">Item Search</h2>
        <br/>
        <label for="name"><fmt:message key="item.name" /></label>
    ...
    <c:if test="${pagedResult != null}" >
        <div id="searchResult">
            ...
            <table>
                ...
                <tbody>
                    <c:forEach items="${pagedResult.pagedResults}" var="item">
                        <tr>
                            <td>
                                ${item.name}
                            </td>
                            ...
                            <td align="center">
                                <c:url var="updateUrl" value="${updateUri}">
                                    <c:param name="mId" value="${itemSearchCommand.mailerId}"/>
