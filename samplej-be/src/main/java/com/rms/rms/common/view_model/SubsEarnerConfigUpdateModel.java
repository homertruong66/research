...
public class SubsEarnerConfigUpdateModel {

    private static final Set<String> CYCLES = Sets.newHashSet(
            SubsEarnerConfig.CYCLE_WEEK,
            SubsEarnerConfig.CYCLE_MONTH,
            SubsEarnerConfig.CYCLE_YEAR
    );
    ...
    public String toString () {
        return "SubsEarnerConfigUpdateModel{" +
